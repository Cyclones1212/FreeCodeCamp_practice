...
<body>
	...
	<div id="fwslider" style="height: 554px;">
		<div class="slider_container">
			<div class="slide" style="opacity: 1; z-index: 1; display: block;">
				<a href="http://www.mingrisoft.com"><img id="img1" src="img/img1.jpg"></a>
			</div>
			<div class="slide" style="opacity: 1; z-index: 0; display: none;">
				<a href="http://www.mingrisoft.com"><img id="img2" src="img/img2.jpg"></a>
			</div>
			<div class="slide" style="opacity: 1; z-index: 0; display: none;">
				<a href="http://www.mingrisoft.com"><img id="img3" src="img/img3.jpg"></a>
			</div>
			<div class="slide" style="opacity: 1; z-index: 0; display: none;">
				<a href="http://www.mingrisoft.com"><img id="img4" src="img/img4.jpg"></a>
			</div>
			<div class="slide" style="opacity: 1; z-index: 0; display: none;">
				<a href="http://www.mingrisoft.com"><img id="img5" src="img/img5.jpg"></a>
			</div>
		</div>
	...
	<div class="address">
		Copyright 2016 明日科技有限公司 All Rights. <br>  
		<a href="http://www.mingrisoft.com">吉林省明日科技有限公司</a> 技术支持 
		<a href="<%=basePath%>/admin/login.jsp">后台</a> <br>
		吉ICP备10002740号-2 吉公网安备22010202000132号
	</div>
	<div class="clear"></div>
